        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
          ...
          >
            ...
            <div>
              <div className="flex items-center justify-between mb-6">
                ...
                <span className="text-xs font-mono text-gray-500 uppercase">{bento.frontendCard.badge}</span>
              </div>
          ...
          >
            <div className="flex items-center justify-between mb-6">
              ...
              <span className="text-xs font-mono text-gray-500">{bento.aiCard.badge}</span>
            </div>
            <div>
          ...
          >
            <div className="flex items-center justify-between mb-6">
              ...
              <span className="text-xs font-mono text-gray-500">{bento.backendCard.badge}</span>
            </div>
            <div>
          ...
          >
            <div className="flex items-center justify-between mb-6">
              ...
              <span className="text-xs font-mono text-gray-500">{bento.designCard.badge}</span>
            </div>
            <div>
          ...
          >
            <div className="flex items-center justify-between mb-6">
              ...
              <span className="text-xs font-mono text-gray-500">{bento.awardsCard.badge}</span>
            </div>
            <div>
            ...
            <div className="mt-6 grid grid-cols-2 gap-4 pt-4 border-t border-white/10 text-xs font-mono">
              {bento.awardsCard.items.map((item, idx) => (
                <div key={idx} className={idx === 0 ? "text-amber-400" : "text-gray-400"}>
                  {item}
                </div>
              ))}
            </div>
          ...
          >
            <div className="flex items-center justify-between mb-6">
              ...
              <span className="text-xs font-mono text-gray-500">{bento.learningCard.badge}</span>
            </div>
            <div>
